...
router.post('/message', tempAuth, async (req, res) => {
    ...
    try {
        ...
        const timeout = 180000; // 3 minutes for complex queries
        const maxRetries = 2;
        let lastError = null;
        ...
        for (let attempt = 1; attempt <= maxRetries; attempt++) {
            try {
                console.log(`[DEBUG] Attempt ${attempt}/${maxRetries} - Sending request to AI service...`);
